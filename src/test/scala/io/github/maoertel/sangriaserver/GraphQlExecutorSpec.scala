...
class GraphQlExecutorSpec extends org.specs2.mutable.Specification {
...
//    val helloWorld = GraphQLExecutor.impl[IO]
//    GraphQLServerRoutes.graphQlRoutes(helloWorld).orNotFound(getHW).unsafeRunSync()
//  }
//
